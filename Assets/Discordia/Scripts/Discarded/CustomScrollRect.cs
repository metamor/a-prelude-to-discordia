...
namespace UnityEngine.UI
{
    ...
    {
        /// <summary>
        /// Enum for which modifier key to use with the mouse button to drag the scroll rect content.
        /// </summary>
        public enum MouseButton
        {
            ...
            /// <summary>
            /// Use the shift modifier key and mouse button to drag the content of the scroll rect.
            /// </summary>
            Shift,

            /// <summary>
            /// Use the ctrl modifier key and mouse button to drag the content of the scroll rect.
            /// </summary>
            Ctrl,

            /// <summary>
            /// Use the alt modifier key and mouse button to drag the content of the scroll rect.
            /// </summary>
            Alt,

            /// <summary>
            /// Use the command modifier key and mouse button to drag the content of the scroll rect.
            /// </summary>
            Command,
        }
        ...
        // enable left mouse to drag ScrollRect content
        [SerializeField]
        protected bool mouseDrag = true;

        [SerializeField]
        protected MouseDragModifierKey m_MouseDragModifierKey = MouseDragModifierKey.Ctrl;
...
#pragma warning restore 649
        ...
        public virtual void OnBeginDrag(PointerEventData eventData)
        {
            if (mouseDrag)
            {
                ...
                /*if (m_MouseDragModifierKey == MouseDragModifierKey.None)
                {
                    Debug.Log("None2");
                    if (eventData.button != PointerEventData.InputButton.Left)
                    {
                        Debug.Log("None2 inside Left");
                        return;
                    }
                }
                else if (m_MouseDragModifierKey == MouseDragModifierKey.Shift)
                {
                    if (eventData.button != PointerEventData.InputButton.Left && !(Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                        return;
                }
                else if (m_MouseDragModifierKey == MouseDragModifierKey.Ctrl)
                {
                    if ((eventData.button != PointerEventData.InputButton.Left) && (Input.GetKey(KeyCode.LeftControl)))
                        return;
                }
                else if (m_MouseDragModifierKey == MouseDragModifierKey.Alt)
                {
                    if (eventData.button != PointerEventData.InputButton.Left && !(Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.RightAlt)))
                        return;
                }*/

                // if left mouse button isn't pressed or shift keys aren't pressed
                //if (((eventData.button != PointerEventData.InputButton.Left) == true) || (Input.GetKey(KeyCode.LeftShift) == false && Input.GetKey(KeyCode.RightShift) == false))
                //{
        ...
        public virtual void OnEndDrag(PointerEventData eventData)
        {
            if (mouseDrag)
            {
                Debug.Log("OnEndDrag1");
                if (eventData.button != PointerEventData.InputButton.Left)
                {
                    Debug.Log("OnEndDrag2");
                    return;
                }
                Debug.Log("OnEndDrag3");
                m_Dragging = false;
            }
        }
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                UISystemProfilerApi.AddMarker("CustomScrollRect.value", this);
